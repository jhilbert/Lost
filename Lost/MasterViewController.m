...
//    NSManagedObject *newManagedObject = [NSEntityDescription insertNewObjectForEntityForName:[entity name] inManagedObjectContext:context];
    ...
    if ([segue.identifier isEqualToString:@"newCharacter"])
    {
        [characters addObject:[vc newCharacter]];
        indexPath = [NSIndexPath indexPathForRow:characters.count - 1  inSection:0];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
  ...
  //      NSManagedObject *object = [[self fetchedResultsController] objectAtIndexPath:indexPath];
        Character *object = characters[indexPath.row];

        [[segue destinationViewController] setEditedCharacter:((Character*)object)];
    }
}
...
{
    NSManagedObject *object = [self.fetchedResultsController objectAtIndexPath:indexPath];
    cell.textLabel.text = [[object valueForKey:@"actor"] description];
}
